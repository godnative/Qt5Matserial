...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalGroupBox.setGeometry(QtCore.QRect(210, 20, 401, 491))
        ...
        self.widget.setGeometry(QtCore.QRect(700, 20, 751, 491))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "当前接收："))
