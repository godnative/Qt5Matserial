...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_mode1_startfr = QtWidgets.QLineEdit(self.verticalGroupBox_2)
        self.lineEdit_mode1_startfr.setObjectName("lineEdit_mode1_startfr")
        self.horizontalLayout_3.addWidget(self.lineEdit_mode1_startfr)
        self.label_3 = QtWidgets.QLabel(self.verticalGroupBox_2)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_3.addWidget(self.label_3)
        self.lineEdit_mode1_stopfr = QtWidgets.QLineEdit(self.verticalGroupBox_2)
        self.lineEdit_mode1_stopfr.setObjectName("lineEdit_mode1_stopfr")
        self.horizontalLayout_3.addWidget(self.lineEdit_mode1_stopfr)
        self.label_4 = QtWidgets.QLabel(self.verticalGroupBox_2)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_3.addWidget(self.label_4)
        self.lineEdit_mode1_step = QtWidgets.QLineEdit(self.verticalGroupBox_2)
        self.lineEdit_mode1_step.setObjectName("lineEdit_mode1_step")
        self.horizontalLayout_3.addWidget(self.lineEdit_mode1_step)
        ...
        self.textBrowser_sentdata.setGeometry(QtCore.QRect(240, 340, 421, 61))
        self.textBrowser_sentdata.setObjectName("textBrowser_sentdata")
        self.button_sentdata_2 = QtWidgets.QPushButton(Form)
        self.button_sentdata_2.setGeometry(QtCore.QRect(250, 310, 409, 23))
        self.button_sentdata_2.setObjectName("button_sentdata_2")
        self.groupBox = QtWidgets.QGroupBox(Form)
        self.groupBox.setGeometry(QtCore.QRect(240, 160, 431, 141))
        self.groupBox.setObjectName("groupBox")
        self.toolButton_addcurfr = QtWidgets.QToolButton(self.groupBox)
        self.toolButton_addcurfr.setGeometry(QtCore.QRect(10, 20, 45, 45))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(36)
        self.toolButton_addcurfr.setFont(font)
        self.toolButton_addcurfr.setArrowType(QtCore.Qt.NoArrow)
        self.toolButton_addcurfr.setObjectName("toolButton_addcurfr")
        self.toolButton_deccurfr = QtWidgets.QToolButton(self.groupBox)
        self.toolButton_deccurfr.setGeometry(QtCore.QRect(10, 80, 45, 45))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(48)
        self.toolButton_deccurfr.setFont(font)
        self.toolButton_deccurfr.setArrowType(QtCore.Qt.NoArrow)
        self.toolButton_deccurfr.setObjectName("toolButton_deccurfr")
        self.lineEdit_mode2_curfr = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_mode2_curfr.setGeometry(QtCore.QRect(180, 20, 181, 21))
        self.lineEdit_mode2_curfr.setObjectName("lineEdit_mode2_curfr")
        self.label_8 = QtWidgets.QLabel(self.groupBox)
        self.label_8.setGeometry(QtCore.QRect(90, 20, 91, 16))
        self.label_8.setObjectName("label_8")
        self.lineEdit_mode2_step = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_mode2_step.setGeometry(QtCore.QRect(180, 60, 181, 21))
        self.lineEdit_mode2_step.setObjectName("lineEdit_mode2_step")
        self.label_9 = QtWidgets.QLabel(self.groupBox)
        self.label_9.setGeometry(QtCore.QRect(90, 60, 81, 16))
        self.label_9.setObjectName("label_9")
        self.button_sentmode2 = QtWidgets.QPushButton(self.groupBox)
        self.button_sentmode2.setGeometry(QtCore.QRect(90, 100, 271, 23))
    ...
    def retranslateUi(self, Form):
        ...
        self.verticalGroupBox_2.setTitle(_translate("Form", "定时发送"))
        self.label_2.setText(_translate("Form", "起始频率(kHz)"))
        self.lineEdit_mode1_startfr.setText(_translate("Form", "5075000"))
        self.label_3.setText(_translate("Form", "停止频率(kHz)"))
        self.lineEdit_mode1_stopfr.setText(_translate("Form", "5650000"))
        self.label_4.setText(_translate("Form", "步进(kHz)"))
        self.lineEdit_mode1_step.setText(_translate("Form", "1"))
        ...
        self.groupBox.setTitle(_translate("Form", "调整发送"))
        self.toolButton_addcurfr.setText(_translate("Form", "+"))
        self.toolButton_deccurfr.setText(_translate("Form", "-"))
        self.lineEdit_mode2_curfr.setText(_translate("Form", "5075000"))
        self.label_8.setText(_translate("Form", "当前频率(kHz)"))
        self.lineEdit_mode2_step.setText(_translate("Form", "1"))
        self.label_9.setText(_translate("Form", "步进频率(kHz)"))
        self.button_sentmode2.setText(_translate("Form", "发送数据"))
